...
const index = () => {
  return (
    <article className="flex flex-col bg-white justify-around w-[19rem] h-[20rem] rounded-2xl shadow-[5px_5px_8px_rgba(0,0,0,0.25)] transition-all duration-500">
      <div className="flex items-center justify-center">
        <Image className="rounded-2xl" alt="productSlideImage" width={280} height={140} src={"/images/productSlider/ganj.jpg"} />
      </div>
